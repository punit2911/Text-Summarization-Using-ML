...
from helper import get_summary, spacy_render, fetch_news, fetch_news_links
...
if choice == "Custom Text Summarization":
    ...
    if st.button("Get Summary and Headline"):
        ...
        with col2:
            ...
            spacy_render(summary)
            spacy_render(text, visualize_full_article=True)
...
if choice == "News Summary and Headlines":
    ...
    fetch_news_data = fetch_news(link)
